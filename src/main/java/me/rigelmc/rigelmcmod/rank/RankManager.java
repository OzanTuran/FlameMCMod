...
public class RankManager extends FreedomService
{
    ...
    public Displayable getDisplay(CommandSender sender)
    {
        ...
        if (FUtil.FMCDEVS.contains(player.getName()) && !ConfigEntry.SERVER_OWNERS.getList().contains(player.getName()) && !ConfigEntry.SERVER_COOWNERS.getList().contains(player.getName()) && !ConfigEntry.SERVER_RETIREES.getList().contains(player.getName()))
        {
            return Title.FMCDEV;
        }
        ...
        if (ConfigEntry.SERVER_EXECS.getList().contains(player.getName()) && !FUtil.FMCDEVS.contains(player.getName()) && !ConfigEntry.SERVER_OWNERS.getList().contains(player.getName()) && !ConfigEntry.SERVER_OWNERS.getList().contains(player.getName()) && !ConfigEntry.SERVER_RETIREES.getList().contains(player.getName()))
        {
            return Title.EXEC;
        }
